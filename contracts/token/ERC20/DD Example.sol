...
$$$$$$$/  $$/ $$/   $$/ $$/   $$/       $$$$$$$/   $$$$$$/  $$/ $$/   $$/ $$/   $$/           
   ...
   The Millenial Hero No One Saw Coming
...
contract DinkDoinkToken is Context, IERC20, Ownable {
    ...
    string private _name = "DinkDoink";
    string private _symbol = "DINK";
    ...
    uint256 public _maxTxAmount = 8000000000000 * 10**1 * 10**9;
